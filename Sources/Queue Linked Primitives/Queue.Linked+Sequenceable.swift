...
// (Queue.Linked+Sequenceable.swift) per [MOD-036] refined-C; this conformance is thin and splits
// the `Iterator` associated-type binding from `Iterable`'s via `@_implements`.
//
// `Queue.Linked` does not conform to `Swift.Sequence`: the span-primitive iteration family is
